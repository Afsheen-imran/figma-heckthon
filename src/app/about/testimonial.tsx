...
const Testimonial1 = () => {
  return (
    <div className="w-full max-w-[1273px] mx-auto h-auto">
      <div className="px-4 sm:px-8 lg:px-16 py-12 bg-gray-50">
        ...
        <div className="flex flex-col items-center text-center pb-8">
          ...
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            ...
            <h2 className="text-[#333333] font-bold text-2xl my-4">Alamin Hasan</h2>
