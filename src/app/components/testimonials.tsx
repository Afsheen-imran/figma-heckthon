...
const Testimonials = () => {
  return (
    <div className="bg-[#0D0D0D] px-4 sm:px-8 lg:px-16 py-12">
      ...
      <div className="flex flex-col items-center text-center pb-8">
        ...
        <div className="max-w-4xl mx-auto bg-[#ffffff] p-8 rounded-lg shadow-lg">
          ...
          <p className="leading-relaxed text-[#4F4F4F] text-lg">
            ...
            taxidermy 90s cronut plus one kinfolk. Single-origin coffee ennui shaman
            ...
            before they sold out gentrify plaid gastropub normcore XOXO 90s pickled
      ...
      <Image src="/images/Dot.png" alt="dots" width={86} height={16} className="ml-[47%]" />
    </div>
  );
};
