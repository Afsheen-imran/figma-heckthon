...
const FoodItems = () => {
  ...
  const items = [
    { id: 1, img: "/images/image-5.png", label: "Save 50% on Fast Food" },
    { id: 2, img: "/images/image-6.jpg", label: "Delicious Burgers" },
    { id: 3, img: "/images/image-7.jpg", label: "Healthy Salads" },
    { id: 4, img: "/images/image-8.jpg", label: "Desserts" },
  ];
